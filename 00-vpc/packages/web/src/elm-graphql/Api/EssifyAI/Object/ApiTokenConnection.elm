...
module Api.EssifyAI.Object.ApiTokenConnection exposing (..)
...
edges :
    SelectionSet decodesTo Api.EssifyAI.Object.ApiTokenEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.EssifyAI.Object.ApiTokenConnection
edges object____ =
