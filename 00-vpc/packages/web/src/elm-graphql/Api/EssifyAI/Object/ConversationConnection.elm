...
module Api.EssifyAI.Object.ConversationConnection exposing (..)
...
edges :
    SelectionSet decodesTo Api.EssifyAI.Object.ConversationEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.EssifyAI.Object.ConversationConnection
edges object____ =
