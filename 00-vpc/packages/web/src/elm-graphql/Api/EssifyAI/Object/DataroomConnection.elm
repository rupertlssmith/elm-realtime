...
module Api.EssifyAI.Object.DataroomConnection exposing (..)
...
edges :
    SelectionSet decodesTo Api.EssifyAI.Object.DataroomEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Api.EssifyAI.Object.DataroomConnection
edges object____ =
