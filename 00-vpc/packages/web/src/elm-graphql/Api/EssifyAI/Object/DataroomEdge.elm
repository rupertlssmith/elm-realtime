...
module Api.EssifyAI.Object.DataroomEdge exposing (..)
...
cursor : SelectionSet (Maybe String) Api.EssifyAI.Object.DataroomEdge
cursor =
...
node :
    ...
    -> SelectionSet (Maybe decodesTo) Api.EssifyAI.Object.DataroomEdge
node object____ =
