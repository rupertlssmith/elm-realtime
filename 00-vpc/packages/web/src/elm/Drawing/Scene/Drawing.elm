module Drawing.Scene.Drawing exposing (Drawing, GestureCondition(..), add, empty)
...
import Drawing.GestureEvent as GestureEvent exposing (GestureEvent)
import Drawing.Msg exposing (GestureLocation(..), Msg(..))
import Drawing.Scene.Spec as Spec
    exposing
        ( Entity(..)
        , EntityId
        , Scene(..)
...
viewScene model =
    HS.div [ HA.id "drawing-container" ]
        [ svgDrawing model |> Svg.Styled.fromUnstyled
        ]
