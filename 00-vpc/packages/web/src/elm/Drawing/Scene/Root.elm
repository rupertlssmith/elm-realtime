module Drawing.Scene.Root exposing (Root, root)
...
import Color
import Drawing.Scene.Spec as Spec exposing (Entity, EntityId, UpdateContext(..), ViewContextIF)
import Drawing.Style as Style
    ...
    if pow >= end then
        ...
        Svg.pattern
            ...
            [ Svg.rect
                ...
                , InPx.x 0
                , InPx.y 0
                , Color.rgb255 212 212 212 |> Paint |> SvgAttr.stroke
                , InPx.strokeWidth (tenpow / 800 + 0.05)
