...
subscriptions : Protocol (Realtime a) msg model -> Realtime a -> Sub msg
...
update : Protocol (Realtime a) msg model -> Msg -> Realtime a -> ( model, Cmd msg )
...
getChannelDetails : Realtime a -> RandomizedState -> ( RandomizedState, Cmd Msg )
